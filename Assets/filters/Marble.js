...
Phaser.Filter.Marble = function (game) {
    ...
    this.fragmentSrc = [
        ...
        "{",
            ...
            "vec3 col=vec3(color_intensity*sin(3.0*p.x)+color_intensity*1.0,color_intensity*sin(3.0*p.y)+color_intensity*0.2,color_intensity*sin(p.x+p.y)+color_intensity*0.1);",
